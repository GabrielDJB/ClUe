...
final class TratadorCarregarJogo implements ActionListener {
	...
	//
	// Parâmetro: ActionEvent e - Referência para o evento sobre o botão de
...
//
// Descrição: Painel de início de jogo. Contém os botões NOVO JOGO e CARREGAR
// JOGO.
//
...
public class StartPanel extends JPanel {
	...
	//
	// Descrição: Inicia o painel com sua largura e sua altura, também
	// carregando a imagem do título.
	//
	...
	//
	// Parâmetros: Insets in - Dimensões do container, int width - Largura do
