...
final class CardButtonHandler implements ActionListener {
	...
	//
	// Descrição: Método acionado automaticamente ao ocorrer de um clique sobre o botão de cartas.
	//
	// Parâmetros: e - Action Event sobre o elemento no qual uma instância dessa classe está registrado.
	//
	// Retorno: Sem retorno.
	//
...
public class CardPanel extends JPanel {
	...
	// Método CardPanel
	//
	// Descrição: Instancia essa classe, inicializando o JPanel com o botão, já com seu Action Listener.
	//
